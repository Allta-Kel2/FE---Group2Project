      ...
      />
        <div className="flex flex-col w-full mx-80">
          ...
          <div className='flex flex-col border-b-2'>
            <p className='ml-10 my-5 font-bold text-sky-900 text-4xl'> Dashboard </p>
          
            <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-35 mr-10">
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow px-8 py-6 flex items-center">
                    <div className="p-3 bg-orange-500 shadow rounded-full">
